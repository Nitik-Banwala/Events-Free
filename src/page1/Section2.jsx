        ...
        <div className="max-w-310 mx-auto px-4 py-16 font-[Poppins,sans-serif] ">
            <div className="flex flex-col lg:flex-row gap-12 items-center">
                ...
                <div className="w-full lg:w-1/2">
                    ...
                    <p className="text-[16px] mt-4 max-w-xl font-[Poppins,sans-serif]">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc efficitur urna
                        dictum suscipit. Suspendisse maximus ipsum sem. Donec ut justo et leo
                        congue lacinia vitae nec arcu.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-8 mt-14">
                        <div className="relative flex justify-center w-full sm:w-1/2">
                            <div className="absolute -top-10 w-20 h-20 border-2 border-[#2C49FE] rounded-full bg-white flex items-center justify-center">
                            ...
                            <div className="group w-full max-w-65 h-50 border-2 border-[#2C49FE]  hover:bg-[#2C49FE] rounded-md pt-12 px-10 max-[1171px]:px-4 text-center transition">
                                <h2 className="text-[#2D3CAE] text-2xl font-semibold  group-hover:text-white transition">
                                    Sharing
                                </h2>
                                <p className="text-[#2D3CAE] text-[16px] mt-2  group-hover:text-white transition">
                                    Lorem ipsum dolor sit <br /> amet, consectetur <br />
                                    adipiscing elit. Nunc <br /> efficitur urna in
                                </p>
                            </div>
                        </div>
                        <div className="relative flex mt-3 mb-3 sm:mb-0 sm:mt-0 justify-center w-full sm:w-1/2">
                            <div className="absolute -top-10 w-20 h-20 border-2 border-[#2C49FE] rounded-full bg-white flex items-center justify-center">
                    ...
                    <div className="flex justify-center mt-9 hover:text-white">
                        <div className="relative flex justify-center">
                            ...
                            <div className="group w-full max-w-65 h-50 border-2 border-[#2C49FE]  hover:bg-[#2C49FE] rounded-md pt-12 px-10 text-center transition">
                                <h2 className="text-[#2D3CAE] text-2xl font-semibold  group-hover:text-white transition">
                                    Help
                                </h2>
                                <p className="text-[#2D3CAE] text-[16px] mt-2 font-[Poppins,sans-serif]  group-hover:text-white transition">
                                    Lorem ipsum dolor sit <br /> amet, consectetur <br />
                                    adipiscing elit. Nunc <br /> efficitur urna in
                                </p>
                            </div>
