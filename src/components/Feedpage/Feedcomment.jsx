            ...
            {comments.map((comment) => (
                <div key={comment.id} className="flex gap-4">
                    ...
                    <div className="flex-1">
                        <div className="bg-[#F1F2F5] rounded-b-[20px] rounded-r-[20px] p-4">
                        ...
                        <button
                            ...
                            className="flex items-center ml-8 gap-2 text-xl  text-black opacity-50 mt-2 hover:text-red-500"
                        >
...
export const Addfeedcomment = ({ onAddComment, onDeleteComment }) => {
            ...
            <div className=" p-6">
                <div className="flex gap-3 max-[750px]:hidden  rounded-4xl border mb-8 border-[#9CA1BE]  p-2 shadow-sm">
                    ...
                    <input
                        ...
                        className="w-[85%] p-3 max-[600px]:text-[12px]  max-[600px]:w-[75%] border-none outline-none pl-15 "
                    />
                    <button
                        onClick={addTask}
                        className="w-[15%] px-5 bg-[#2C49FE] text-white font-semibold max-[600px]:w-[25%] rounded-4xl max-[945px]:text-[10px] max-[945px]:p-1 hover:opacity-90 transition"
                    >
                        Post Comment
                    </button>
                </div>
